...
BEGIN
	...
	SELECT
		...
		has_exposures AS algae21010_has_exposures,
		is_out_of_bounds AS algae2111_is_out_of_bounds,
		maximum_life_stage_overlap AS algae2112_max_life_stage_overlap,
		is_fixed_invalid_geocode AS algae2113_max_stage_over_lap,
		fit_extent AS algae2114_fit_extent,
		adjusted_start_date AS algae2115_adj_start_date,
		adjusted_end_date AS algae2116_adj_end_date,
		days_changed AS algae2117_days_changed,
		fit_type AS algae2118_fit_type,
		start_date_delta1 AS algae2119_start_date_delta1,
		start_date_delta2 AS algae2120_start_date_delta2,
		end_date_delta1 AS algae2121_end_date_delta1,
		end_date_delta2 AS algae2122_end_date_delta2,
		previous_geocode AS algae2123_previous_geocode,
		next_geocode AS algae2124_next_geocode,
		fin_adjusted_start_date AS algae2125_fin_adj_start_date,
		imputed_first_start AS algae2126_imputed_first_start,
		fin_adjusted_end_date AS algae2127_fin_adj_end_date,
		imputed_last_end AS algae2128_imputed_last_end,
		start_date_days_from_conception AS algae2129_start_date_days_from_concep,
		is_within_exposure_time_frame AS algae2130_is_within_exp,
		has_bad_geocode_within_time_frame AS algae2131_has_bad_geocode_within_exp
	FROM
	...
	SELECT
		...
		name_sum AS algae3102_name_sum,
		name_err_sum AS algae3103_name_err_sum,
		name_avg AS algae3104_name_avg,
		name_err_avg AS algae3105_name_err_avg,
		name_med AS algae3106_name_med,
		name_err_med AS algae3107_name_err_med,
		nox_rd_sum AS algae3108_nox_rd_sum,
		nox_rd_err_sum AS algae3109_nox_rd_err_sum,
		nox_rd_avg AS algae3110_nox_rd_avg,
		nox_rd_err_avg AS algae3111_nox_rd_err_avg,
		nox_rd_med AS algae3112_nox_rd_med,
		nox_rd_err_med AS algae3113_nox_rd_err_med,
		pm10_gr_sum AS algae3114_pm10_gr_sum,
		pm10_gr_err_sum AS algae3115_pm10_gr_err_sum,
		pm10_gr_avg AS algae3116_pm10_gr_avg,
		pm10_gr_err_avg AS algae3117_pm10_gr_err_avg,
		pm10_gr_med AS algae3118_pm10_gr_med,
		pm10_gr_err_med AS algae3119_pm10_gr_err,
		pm10_rd_sum AS algae3120_pm10_rd_sum,
		pm10_rd_err_sum AS algae3121_pm10_rd_err_sum,		
		pm10_rd_avg AS algae3122_pm10_rd_avg,
		pm10_rd_err_avg AS algae3123_pm10_rd_err_avg,
		pm10_rd_med AS algae3124_pm10_rd_med,
		pm10_rd_err_med AS algae3125_pm10_rd_err_med,
		pm10_tot_sum AS algae3126_pm10_tot_sum,
		pm10_tot_err_sum AS algae3127_pm10_tot_err_sum,		
		pm10_tot_avg AS algae3128_pm10_tot_avg,
		pm10_tot_err_avg AS algae3129_pm10_tot_err_avg,
		pm10_tot_med AS algae3130_pm10_tot_med,
		pm10_tot_err_med AS algae3131_pm10_tot_err_med
	FROM
		fin_mob_cln_exp
	ORDER BY
		person_id,
	...
	SELECT
		...
		name_sum AS algae3202_name_sum,
		name_avg AS algae3203_name_avg,
		name_med AS algae3204_name_med,
		nox_rd_sum AS algae3205_nox_rd_sum,
		nox_rd_avg AS algae3206_nox_rd_avg,
		nox_rd_med AS algae3207_nox_rd_med,
		pm10_gr_sum AS algae3208_pm10_gr_sum,
		pm10_gr_avg AS algae3209_pm10_gr_avg,
		pm10_gr_med AS algae3210_pm10_gr_med,
		pm10_rd_sum AS algae3211_pm10_rd_sum,
		pm10_rd_avg AS algae3212_pm10_rd_avg,
		pm10_rd_med AS algae3213_pm10_rd_med,
		pm10_tot_sum AS algae3214_pm10_tot_sum,
		pm10_tot_avg AS algae3215_pm10_tot_avg,
		pm10_tot_med AS algae3216_pm10_tot_med
	FROM
		fin_mob_uncln_exp
	ORDER BY
		person_id,
	...
	SELECT
		...
		name_sum AS algae3302_name_sum,
		name_avg AS algae3303_name_avg,
		name_med AS algae3304_name_med,
		nox_rd_sum AS algae3305_nox_rd_sum,
		nox_rd_avg AS algae3306_nox_rd_avg,
		nox_rd_med AS algae3307_nox_rd_med,
		pm10_gr_sum AS algae3308_pm10_gr_sum,
		pm10_gr_avg AS algae3309_pm10_gr_avg,
		pm10_gr_med AS algae3310_pm10_gr_med,
		pm10_rd_sum AS algae3311_pm10_rd_sum,
		pm10_rd_avg AS algae3312_pm10_rd_avg,
		pm10_rd_med AS algae3313_pm10_rd_med,
		pm10_tot_sum AS algae3314_pm10_tot_sum,
		pm10_tot_avg AS algae3315_pm10_tot_avg,
		pm10_tot_med AS algae3316_pm10_tot_med
	FROM
		fin_stg_mob_exp
	ORDER BY
		person_id,
	...
	SELECT
		...
		out_of_bounds_geocodes AS algae6106_oob_geocodes,
		invalid_geocodes AS algae6107_inv_geocodes,
		fixed_geocodes AS algae6108_fixed_geocodes,
		over_laps AS algae6109_over_laps,
		gaps AS algae6110_gaps,
		gap_and_overlap_same_period AS algae6111_gap_over_lap,
		deletions AS algae6112_deletions,
		imp_blank_start_dates AS algae6113_cln_blank_start_date,
		imp_blank_end_dates AS algae6114_cln_blank_end_date,
		imp_blank_both_dates AS algae6115_cln_blank_both_dates,
		imp_last_dates AS algae6116_cln_last_dates,
		days_changed AS algae6117_days_changed,
		has_bad_geocode_within_time_frame AS algae6118_has_bad_geocode_in_exp,
		total_contention_days AS algae6119_contention_days,
		missing_exposure_days AS algae6120_missing_exp
	FROM
		fin_sens_variables
	ORDER BY
		person_id;
