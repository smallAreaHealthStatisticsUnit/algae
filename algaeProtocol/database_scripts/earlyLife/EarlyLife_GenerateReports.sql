...
BEGIN
	...
	SELECT
		...
		name_sum AS algae3427_name_sum,
		name_avg AS algae3428_name_avg,
		name_med AS algae3429_name_med,
		nox_rd_sum AS algae3430_nox_rd_sum,
		nox_rd_avg AS algae3431_nox_rd_avg,
		nox_rd_med AS algae3432_nox_rd_med,
		pm10_gr_sum AS algae3433_pm10_gr_sum,
		pm10_gr_avg AS algae3434_pm10_gr_avg,
		pm10_gr_med AS algae3435_pm10_gr_med,
		pm10_rd_sum AS algae3436_pm10_rd_sum,
		pm10_rd_avg AS algae3437_pm10_rd_avg,
		pm10_rd_med AS algae3438_pm10_rd_med,
		pm10_tot_sum AS algae3439_pm10_tot_sum,
		pm10_tot_avg AS algae3440_pm10_tot_avg,
		pm10_tot_med AS algae3441_pm10_tot_med
	FROM
