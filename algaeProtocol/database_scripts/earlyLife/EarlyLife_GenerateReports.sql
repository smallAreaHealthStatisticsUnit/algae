...
BEGIN
	...
	SELECT
		...
		name_invalid_address_days AS algae3108_name_inv_addr_days,
		name_oob_days AS algae3109_name_oob_days,
		name_poor_address_days AS algae3110_name_poor_addr_days,
		name_missing_exp_days AS algae3111_name_missing_exp_days,
		name_good_address_days AS algae3112_name_good_addr_days,
		...
		pm10_gr_err_med AS algae3145_pm10_gr_err,
	...
	SELECT
		...
		name_invalid_address_days AS algae3208_name_inv_addr_days,
		name_oob_days AS algae3209_name_oob_days,
		name_poor_address_days AS algae3210_name_poor_addr_days,
		name_missing_exp_days AS algae3211_name_missing_exp_days,
		name_good_address_days AS algae3212_name_good_addr_days,
	...
	SELECT
		...
		name_invalid_address_days AS algae3308_name_inv_addr_days,
		name_oob_days AS algae3309_name_oob_days,
		name_poor_address_days AS algae3310_name_poor_addr_days,
		name_missing_exp_days AS algae3311_name_missing_exp_days,
		name_good_address_days AS algae3312_name_good_addr_days,
	...
	SELECT
		...
		name_invalid_address_days AS algae3408_name_inv_addr_days,
		name_oob_days AS algae3409_name_oob_days,
		name_poor_address_days AS algae3410_name_poor_addr_days,
		name_missing_exp_days AS algae3411_name_missing_exp_days,
		name_good_address_days AS algae3412_name_good_addr_days,
