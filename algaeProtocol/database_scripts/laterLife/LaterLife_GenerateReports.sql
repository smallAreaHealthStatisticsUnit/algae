...
*/
	...
	SELECT
		...
		name_sum AS algae3627_name_sum,
		name_avg AS algae3628_name_avg,
		name_med AS algae3629_name_med,
		nox_rd_sum AS algae3630_nox_rd_sum,
		nox_rd_avg AS algae3631_nox_rd_avg,
		nox_rd_med AS algae3632_nox_rd_med,
		pm10_gr_sum AS algae3633_pm10_gr_sum,
		pm10_gr_avg AS algae3634_pm10_gr_avg,
		pm10_gr_med AS algae3635_pm10_gr_med,
		pm10_rd_sum AS algae3636_pm10_rd_sum,
		pm10_rd_avg AS algae3637_pm10_rd_avg,
		pm10_rd_med AS algae3638_pm10_rd_med,
		pm10_tot_sum AS algae3639_pm10_tot_sum,
		pm10_tot_avg AS algae3640_pm10_tot_avg,
		pm10_tot_med AS algae3641_pm10_tot_med
	FROM
		fin_mob_uncln_exp
	ORDER BY
		person_id,
	...
	SELECT
		...
		name_invalid_address_days AS algae3702_name_inv_addr_days,
		name_oob_days AS algae3703_name_oob_days,
		name_poor_address_days AS algae3704_name_poor_addr_days,
		name_missing_exp_days AS algae3705_name_missing_exp_days,
		name_good_address_days AS algae3706_name_good_addr_days,
		name_invalid_address_days AS algae3707_name_inv_addr_days,
		name_oob_days AS algae3708_name_oob_days,
		name_poor_address_days AS algae3709_name_poor_addr_days,
		name_missing_exp_days AS algae3710_name_missing_exp_days,
		name_good_address_days AS algae3711_name_good_addr_days,
		pm10_rd_invalid_address_days AS algae3712_pm10_rd_inv_addr_days,
		pm10_rd_oob_days AS algae3713_pm10_rd_oob_days,
		pm10_rd_poor_address_days AS algae3714_pm10_rd_poor_addr_days,
		pm10_rd_missing_exp_days AS algae3715_pm10_rd_missing_exp_days,
		pm10_rd_good_address_days AS algae3716_pm10_rd_good_addr_days,
		pm10_gr_invalid_address_days AS algae3717_pm10_gr_inv_addr_days,
		pm10_gr_oob_days AS algae3718_pm10_gr_oob_days,
		pm10_gr_poor_address_days AS algae3719_pm10_gr_poor_addr_days,
		pm10_gr_missing_exp_days AS algae3720_pm10_gr_missing_exp_days,
		pm10_gr_good_address_days AS algae3721_pm10_gr_good_addr_days,
		pm10_tot_invalid_address_days AS algae3722_pm10_tot_inv_addr_days,
		pm10_tot_oob_days AS algae3723_pm10_tot_oob_days,
		pm10_tot_poor_address_days AS algae3724_pm10_tot_poor_addr_days,
		pm10_tot_missing_exp_days AS algae3725_pm10_tot_missing_exp_days,
		pm10_tot_good_address_days AS algae3726_pm10_tot_good_addr_days,
		name_sum AS algae3727_name_sum,
		name_avg AS algae3728_name_avg,
		name_med AS algae3729_name_med,
		nox_rd_sum AS algae3730_nox_rd_sum,
		nox_rd_avg AS algae3731_nox_rd_avg,
		nox_rd_med AS algae3732_nox_rd_med,
		pm10_gr_sum AS algae3733_pm10_gr_sum,
		pm10_gr_avg AS algae3734_pm10_gr_avg,
		pm10_gr_med AS algae3735_pm10_gr_med,
		pm10_rd_sum AS algae3736_pm10_rd_sum,
		pm10_rd_avg AS algae3737_pm10_rd_avg,
		pm10_rd_med AS algae3738_pm10_rd_med,
		pm10_tot_sum AS algae3739_pm10_tot_sum,
		pm10_tot_avg AS algae3740_pm10_tot_avg,
		pm10_tot_med AS algae3741_pm10_tot_med
	FROM
		fin_stg_mob_exp
	ORDER BY
		person_id,
